...
public class PostAsString1 extends BaseClass1{
	...
	public void createAPayment()
	{
		...
		given().contentType(ContentType.JSON).auth().oauth2(accessToken).when()
		.body(body).post("/payments/payment").then().log().all();
